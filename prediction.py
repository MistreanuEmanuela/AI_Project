...
def train_neuronal_network_multi_class(x, y, alpha_values=[0.01, 0.1, 1.0]):
    ...
    return final_model, history, accuracy[1], x_train, x_test, y_test
...
def predict_instance_RN_continuous(model, instance):
    ...
    return custom_round(predictions[0][0], 0.5)
...
def predict_instance_linear_regression(model, instance):
    ...
    return custom_round(prediction[0], 0.5)
...
def main():
    ...
    RN_model2, history_rn2, accuracy_RN_2, X_train_RN2, X_test_RN2, y_test_RN2 =\
    ...
    print("predicting instance with id3: ", predict_instance_id3(dt_model, [86.7, 92.3, 94.6, 100.0, 99.6]))
    ...
    print("predicting instance with Linear Regression: ", predict_instance_linear_regression(linear_regression_model,
                                                                            ...
                                                                            [86.7, 92.3, 94.6, 100.0, 99.6]))
    print("predicting instance with Random Forest: ", predict_instance_random_forest(rf_model,
                                                                                     [86.7, 92.3, 94.6, 100.0, 99.6]))
